...
open class BANPreferenceUITableViewController: BANBaseUITableViewController {
    ...
    override public func viewDidLoad() {
        ...
        if !BANPlatform.isCatalyst, presentingViewController != nil {
    ...
    @objc public func close_controller(_ btn: UIBarButtonItem){
    ...
    private let cellReuseIdentifier = "BANPreferenceUITableViewControllerCell"
